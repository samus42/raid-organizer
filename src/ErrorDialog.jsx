...
const VersionSyncDialog = () => (
    <>
        ...
        <DialogContent>
            ...
            <div>Go ahead and use the reload action and then try to make your changes again. Or if you don't remember what you just did, hit the cancel button, take a good look, then refresh the page.</div>
        </DialogContent>
        <DialogActions>
...
const UnknownErrorDialog = ({ error }) => (
    <>
        ...
        <DialogContent>
            ...
            <div>You did something Samus didn't plan for, or he screwed up. Big time. You should tell him. Be smug about it when you do.</div>
        </DialogContent>
        <DialogActions>
            <DialogButton action="close">Cancel</DialogButton>
        </DialogActions>
...
const ErrorDialog = ({ error, onClose }) => {
    const Content = error && error.includes('mismatch') ? VersionSyncDialog : UnknownErrorDialog
    return (
